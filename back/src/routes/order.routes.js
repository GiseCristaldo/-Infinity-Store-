...
// Rutas para administradores (definir rutas específicas antes de rutas con parámetros)
...
// Ruta con parámetro debe ir después para evitar capturar '/admin' como ':id'
